...
(user wants to research WHAT to visualize + HOW before building). TWO RENDER TARGETS (user, 2026-09-23):
(a) the browser-canvas panel above, and (b) a TERMINAL-ONLY TUI -- a genuine htop/btop-for-load-balancing
rendered with braille/block glyphs (U+2800 braille, U+2580-259F blocks, sextant/octant density tiers per the
research), the PUREST expression of the "decision monitor, not resource monitor" thesis. SAME design brief +
